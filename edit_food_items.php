...
<div class="col-xs-3">
  ...
  <div class="form-area" style="padding: 10px 10px 110px 10px; ">
    ...
    description='$description',type='$type' where F_ID='$F_ID'");
    }
...
<div class="col-md-6">
 <div class="form-area" style="padding: 0px 100px 100px 100px;">
        ...
        <br style="clear: both">
          ...
          <div class="form-group">
            <label for="type"><span class="text-danger" style="margin-right: 5px;">*</span> Food type: </label>
<select name="type" id="type" class="form-control" placeholder="Your Food type" required="">
