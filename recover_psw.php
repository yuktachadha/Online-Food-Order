...
<?php 
    if(isset($_POST["recover"])){
      ...
      $mail = new PHPMailer;
            ...
            // h-hotel account
            $mail->Username=" 02yukta2000@gmail.com";
            $mail->Password="#kiran12chadha#";

            // send by h-hotel email
            $mail->setFrom(' 02yukta2000@gmail.com','Password Reset');
            // get email from input
            $mail->addAddress($_POST["email"]);
            $mail->addReplyTo(' 02yukta2000@gmail.com');
            // lamkaizhe16@gmail.com
            // HTML body
            $mail->isHTML(true);
            ...
            http://localhost//Online-Food-Order/reset_psw.php
            <br><br>
            <p>With regrads,</p>
