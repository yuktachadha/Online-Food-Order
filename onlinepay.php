...
<html>
  ...
  <head>
    <title> Online Payment | MyMeals </title>
  </head>
		...
		<div class="col-sm-12">	
			...
			<div class="col-sm-4 col-lg-4 col-md-4">
				<div class="thumbnail">
					...
					<form id="checkout-selection" action="razorpay-php-testapp-master\pay.php" method="POST">		
						<input type="hidden" name="item_name" value="'.$foodname.'">
						...
						<input type="hidden" name="contact" value="8979819930">								
